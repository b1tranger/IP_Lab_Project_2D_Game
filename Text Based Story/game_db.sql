...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2025 at 05:25 AM
...
--
ALTER TABLE `progression` ADD PRIMARY KEY (`user_id`);
...
--
ALTER TABLE `game_scores` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 5;

--
-- AUTO_INCREMENT for table `progression`
--
ALTER TABLE `progression` MODIFY `user_id` int (10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 24;
