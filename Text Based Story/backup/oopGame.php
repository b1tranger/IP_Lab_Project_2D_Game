...
class game
{
    ...
    public function __construct($conn, $user_id, $username, $story_id)
    {
        $this->conn = $conn;
    ...
    public function choice1()
    {
        ...
        $sql = "SELECT * FROM story WHERE story_id='$this->story_id'";
    ...
    public function stateChange()
    {
        ...
        $StoryUpdate = $sqlChoiceFetch['story'];
        $this->story_id = $sqlChoiceFetch['story_id'];
        $updateStory = "UPDATE progression SET game_progress = CONCAT(game_progress, '$StoryUpdate') WHERE user_id = '$this->user_id'";
        $query = mysqli_query($this->conn, $updateStory);
    ...
    public function gameLogic($choice)
    {
        ...
        $this->story_state = $this->stateChange();
    }


}

$action = new game($conn, $user_id, $username, $story_id);

if (isset($_POST['submit'])) {
    $choice = $_POST['choice'];
    // $sql = "SELECT * FROM story WHERE choice";
